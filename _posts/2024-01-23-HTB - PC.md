...
Not much do here, other than learning more what port `50051` is used for. By googling "*tcp port 50051 services*" we get multiple references to `gRPC`:
...
sau@pc:~$ cat user.txt
aca07f27fe0ef16a517847631fa10ee2
```
...
cat /root/root.txt
41f0478c7818577e74bdbfb5e0f8ff7d
```
