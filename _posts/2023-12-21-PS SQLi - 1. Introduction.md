...
1. To solve this lab, we simply comment out the `password` field by injecting `'--` after the desired username:
    ...
    ![](C:\Users\User\Documents\GitHub\cspanias.github.io\assets\portswigger\server-side\sqli\lab2_login.png){: width="60%" .normal}

    ![](C:\Users\User\Documents\GitHub\cspanias.github.io\assets\portswigger\server-side\sqli\lab2_solved.png){: width="60%" .normal}
