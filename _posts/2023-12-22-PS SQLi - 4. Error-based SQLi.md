...
We can create our own brute-forcing script using Python3 that works in exactly the same way as the Intruder: trying all lowercase alphanumeric characters and numbers for each of the twenty positions of the password and keeps the correct one based on a `500` response.
