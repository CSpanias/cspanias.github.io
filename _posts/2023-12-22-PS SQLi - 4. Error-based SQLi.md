...
This script is a modification of Rana's [code](https://github.com/rkhal101/Web-Security-Academy-Series/blob/main/sql-injection/lab-12/sqli-lab-12.py). The major modifications are the **automation of cookie grabbing** and the **addition of comments throughout the code**, among other minor changes.

The code is located on this GitHub repo: [lab12_blindSqliWithConditionalErrors.py](https://github.com/CSpanias/cspanias.github.io/blob/main/assets/portswigger/sqli/error_based_sqli/lab12_blindSqliWithConditionalErrors.py). We can run the script, supply it with the page's URL and get the `administrator`'s password:
