...
> GitHub repo: [lab12_blindSqliWithConditionalErrors.py](https://github.com/CSpanias/cspanias.github.io/blob/main/assets/portswigger/sqli/error_based_sqli/lab12_blindSqliWithConditionalgErrors.py)
...
We can run the script, supply it with the page's URL and get the `administrator`'s password:
