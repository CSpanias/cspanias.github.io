...
### 3.1. Enumeration with nmap, nikto, and gobuster
...
As a result, we can use the [Interactive Periodic Table of Elements](https://www.fishersci.co.uk/gb/en/periodic-table.html) to convert each listed element to its atomic number, and by doing this we obtain the following result: `47 80 73 51 84 46 80 78 103`.
